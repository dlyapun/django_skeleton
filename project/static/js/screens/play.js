    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend({
            ...
            init: function() {
                ...
                this.clickEvent = me.event.subscribe("pointerover", this.clickMove.bind(this))

                me.input.registerPointerEvent("pointerdown", this, this.clickMove.bind(this));
                me.input.registerPointerEvent("pointerup", this, this.onRelease.bind(this));
            },

            clickMove : function (event) {
                console.log('clickMove: ', event);
            },
            ...
            draw: function(renderer) {
                if (this.currentTile) {
                    ...
                    this.font.draw (
                        renderer,
                        "( " + this.currentTile.col + "/asd/" + this.currentTile.row + " )",
                        this.diamondShape.pos.x,
